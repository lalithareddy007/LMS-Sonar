...
public class ClassController {
	...
	@GetMapping(path="upcomingClasses/{studentId}",produces="application/json")
	@ResponseBody
	@ApiOperation("Get all Upcoming Classes for particular Student")
	public ResponseEntity getUpcomingClassesForStudent(@PathVariable(value="studentId") String studentId)throws ResourceNotFoundException
	{
		List<ClassDto> classesDTOList=classServices.getUpcomingClassesForStudent(studentId);
		return ResponseEntity.ok(classesDTOList);
	}
	...
	public ResponseEntity <ClassRecordingDTO> getClassRecordingByClassId(@PathVariable("classId") @NotBlank @Positive Long classId) throws ResourceNotFoundException, FileNotFoundException {
	...
	public ResponseEntity<ClassRecordingDTO> downloadClassRecordings(@PathVariable Long csId) throws FileNotFoundException {
