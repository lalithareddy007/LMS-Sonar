...
//		loginDto.setUserLoginEmailId("Steve.Job@gmail.com");
//		loginDto.setPassword("Steve123");
//
...
//
//		String jwtToken = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJTdGV2ZS5Kb2JAZ21haWwuY29tIiwiaWF0IjoxNzEzNzk5MzY4LCJleHAiOjE3MTM4MjgxNjh9.IfZt7F3WjceeN7Ow0d0Gsh5fJflFgvbg827uIWae8TzFKiWxJh4j6gM1Pr3__q_xrfj1PqRIdmbPbKm9eaZDRQ";
//		when(jwtUtils.generateJwtToken(authentication)).thenReturn(jwtToken);
//
//		when(authentication.getPrincipal()).thenReturn(userDetails);
//
//		when(userDetails.getUserId()).thenReturn("U07");
//
//		when(userDetails.getAuthorities()).thenReturn(authorities);
//		// Mocking the UserLogin object
//		UserLogin userLogin = new UserLogin();
//		userLogin.setLoginStatus("ACTIVE"); // or whatever status you want to set
//		Optional<UserLogin> userLoginOptional = Optional.of(userLogin);
//		// Mocking the behavior of userLoginRepository.findByUserLoginEmailIgnoreCase() method
//		when(userLoginRepository.findByUserLoginEmailIgnoreCase(loginDto.getUserLoginEmailId())).thenReturn(userLoginOptional);
//
//		//when
...
//		assertEquals(jwtResponseDtoGot.getUserId(), "U07");
...
//	}
	...
	public void test_CreateEmailUrlConfirmPassword_withToken() {
		...
		// Assert
		String expectedUrl = frontendUrl + "/reset-password?email=" + loginEmail + "&token=" + token;
