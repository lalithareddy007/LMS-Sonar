...
public class AssignmentSubmitServiceTest {
    ...
    @Captor
    private ArgumentCaptor<AssignmentGradedEvent> eventArgumentCaptor;
...
//
//
//        AssignmentGradedEvent assignmentGradedEvent = mock(AssignmentGradedEvent.class);
//        //doNothing().when(eventPublisher).publishEvent(assignmentGradedEvent);
//
//
