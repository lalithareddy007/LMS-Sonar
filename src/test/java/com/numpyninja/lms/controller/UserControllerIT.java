...
public class UserControllerIT {
    ...
    public void testAssignUpdateUserRoleProgramBatchStatus() throws Exception {
        String userId = userRepository.findAll().get(2).getUserId();
    ...
    public void testBatchStatusIsActiveForProgramId() throws Exception {
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("Batch 2 not found with Status as Active for Program 6 " + " \n ", message);
    }

    @Test
    @Order(16)
    public void testGetUserByProgramBatch() throws Exception {
        String userId = userRepository.findAll().get(1).getUserId();
        MvcResult mvcResult = mockMvc.perform(get("/lms/users/programBatch/" + 6).contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("/application/json"))
                .andReturn();
        ...
        assertEquals("Steve", userDtoForUserId.getUserFirstName());
        assertEquals("Job", userDtoForUserId.getUserLastName());
        assertEquals(879123456L, userDtoForUserId.getUserPhoneNumber());
        assertEquals("Idaho", userDtoForUserId.getUserLocation());
        assertEquals("PST", userDtoForUserId.getUserTimeZone());
        assertEquals("https://www.linkedin.com/in/Steve Job/", userDtoForUserId.getUserLinkedinUrl());
        assertEquals("Mechanical Engineering", userDtoForUserId.getUserEduUg());
        assertEquals("Computer Science Engineering", userDtoForUserId.getUserEduPg());
        assertEquals("H4", userDtoForUserId.getUserVisaStatus());
    }
    ...
    public void testGetUsersByProgram() throws Exception {
        String userId =userRepository.findAll().get(1).getUserId();
        final MvcResult mvcResult = mockMvc.perform(get("/lms/users/programs/" + 6).contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
        ...
        assertEquals("Steve", userDtoForUserId.getUserFirstName());
        assertEquals("Job", userDtoForUserId.getUserLastName());
        assertEquals(879123456, userDtoForUserId.getUserPhoneNumber());
        assertEquals("Idaho", userDtoForUserId.getUserLocation());
        assertEquals("PST", userDtoForUserId.getUserTimeZone());
        assertEquals("https://www.linkedin.com/in/Steve Job/", userDtoForUserId.getUserLinkedinUrl());
        assertEquals("Mechanical Engineering", userDtoForUserId.getUserEduUg());
    ...
    public void testGetUserByRoleId() throws Exception {
        //apply the condition
        String userId = userRepository.findAll().get(1).getUserId();
        final MvcResult mvcResult = mockMvc.perform(get("/lms/users/roles/" + "R02").contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
    ...
    @Test
    @Order(27)
    public void testUpdateUserByRoleId() throws Exception {
        String userId = userRepository.findAll().get(1).getUserId();
        final UserRoleProgramBatchDto userRoleProgramBatchDto = new UserRoleProgramBatchDto();
        userRoleProgramBatchDto.setUserId(userId);
        ...
        UserRoleProgramBatchSlimDto userRoleProgramBatchSlimDto = new UserRoleProgramBatchSlimDto();
        userRoleProgramBatchSlimDto.setBatchId(6);
        userRoleProgramBatchSlimDto.setUserRoleProgramBatchStatus("Inactive");
    ...
    public void testGetAllRoles() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/roles")
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
    ...
    @Test
    @Order(29)
    public void testGetBatchIdByInvalidUserId() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/users/user/" + "U51")
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("userId U51 not found", message);
    }
