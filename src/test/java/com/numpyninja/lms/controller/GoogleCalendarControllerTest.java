...
@WithMockUser
class GoogleCalendarControllerTest extends AbstractTestController {
	@Autowired
	...
	public void setup() {
		mockEventRequest = GCalendarEventRequestDTO.builder()
				.attendees(List.of(new EventAttendeesDTO("gkav2022@gmail.com"))).attachments(null)
	...
	void getAllEvents() {
		when(calendarService.getEventsUsingServiceAcc()).thenReturn(List.of(mockEventResponse));
