...
public class AssignmentSubmitControllerIT {
    ...
    public void testSubmitAssignment() throws Exception {
        ...
        assignmentSubmitDTO.setAssignmentId(7L);
        ...
        assertEquals(7, responseDto.getAssignmentId());
    ...
    @Test
    @Order(2)
    public void testAlreadySubmitUserId() throws Exception {
        final AssignmentSubmitDTO assignmentSubmitDTO = new AssignmentSubmitDTO();
        assignmentSubmitDTO.setAssignmentId(7L);
        assignmentSubmitDTO.setUserId("U06");
        assignmentSubmitDTO.setSubDesc("Submission of data science assignment");
        ...
        assertEquals("Assignment with ID 7 already submitted by student "+ userId +
    ...
    public void testSubmitAssignmentPostDueDate() throws Exception {
        final AssignmentSubmitDTO assignmentSubmitDTO = new AssignmentSubmitDTO();
        assignmentSubmitDTO.setAssignmentId(6L);
        assignmentSubmitDTO.setUserId("U06");
    ...
    public void testGetSubmissionsByBatchId() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/lms/assignmentsubmission/studentbatch/" + 12)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
        ...
        assertEquals(7,  assignmentSubmitForSubmissionId .getAssignmentId());
    ...
    public void testResubmitAssignment() throws Exception {
        final AssignmentSubmitDTO assignmentSubmitDTO = new AssignmentSubmitDTO();
        assignmentSubmitDTO.setAssignmentId(7L);
        assignmentSubmitDTO.setUserId("U08");
        assignmentSubmitDTO.setSubDesc("Submission of data science assignment");
        assignmentSubmitDTO.setSubComments("Submission of project");
        assignmentSubmitDTO.setSubPathAttach1("Filepath1");
        assignmentSubmitDTO.setSubPathAttach2("Filepath2");
        ...
        String jsonRequest = obj.writeValueAsString(assignmentSubmitDTO);
        MvcResult mvcResult = mockMvc.perform(put("/lms/assignmentsubmission/" + 10)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json")
                        .content(jsonRequest))
    ...
    public void testGradeAssignmentSubmission() throws Exception {
        ...
        assignmentSubmitDTO.setSubPathAttach5("Filepath5");
        assignmentSubmitDTO.setSubDateTime(Timestamp.valueOf("2023-10-30 02:10:00"));
        assignmentSubmitDTO.setGradedBy("U07");
        assignmentSubmitDTO.setGradedDateTime(Timestamp.valueOf("2023-11-11 02:10:00"));
        assignmentSubmitDTO.setGrade(299);

        String jsonRequest = obj.writeValueAsString(assignmentSubmitDTO);
        MvcResult mvcResult = mockMvc.perform(put("/lms/assignmentsubmission/gradesubmission/" + 10)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " +
                                generateToken("John.Matthew@gmail.com", "John123"))
                        .contentType("application/json")
    ...
    public void testValidRoleId() throws Exception {
        ...
        assignmentSubmitDTO.setSubPathAttach5("Filepath5");
        assignmentSubmitDTO.setSubDateTime(Timestamp.valueOf("2023-10-30 02:10:00"));
        assignmentSubmitDTO.setGradedBy("U08");
        assignmentSubmitDTO.setGradedDateTime(Timestamp.valueOf("2023-11-11 02:10:00"));
        assignmentSubmitDTO.setGrade(299);
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("User U08 is not allowed to grade the submission", message);
    }

    @Test
    @Order(13)
    public void testGetGradesByAssignmentId() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/lms/assignmentsubmission/getGrades/" + 7)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
    ...
    public void testGetGradesByBatchId() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/lms/assignmentsubmission/grades/" + 12)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
    ...
    public void testGetSubmissionsByAssignmentId() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/lms/assignmentsubmission/" + 7)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
    ...
    public void testGetGradesByProgramId() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/lms/assignmentsubmission/program/" + 11)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
    ...
    public void testDeleteSubmission() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(delete("/lms/assignmentsubmission/" + 10)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
