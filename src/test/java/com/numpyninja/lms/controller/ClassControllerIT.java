...
public class ClassControllerIT {
    ...
    public void testCreateAndSaveClass() throws Exception {
        ...
        classDto.setBatchId(6);
        classDto.setClassTopic("DA");
        classDto.setClassStaffId("U07");
        ...
        classDto.setClassStatus("class start soon");
        ...
        assertEquals("U07", responseDto.getClassStaffId());
    ...
    public void testInvalidStaffId() throws Exception {
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("staffid U09 not found", message);
    }
    ...
    public void testGetAllClassesByClassTopic() throws Exception {
        ...
        assertEquals(6,  classDtoForCsId.getBatchId());
        assertEquals(2,  classDtoForCsId.getClassNo());
        assertEquals("DA",  classDtoForCsId.getClassTopic());
        assertEquals("U07",  classDtoForCsId.getClassStaffId());
    ...
    public void testGetClassesByBatchId() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/classesbyBatch/" + 6).contextPath("/lms")
                .header("Authorization", "Bearer " + token)
                .contentType("application/json")).andReturn();
    ...
    public void testGetClassByInvalidStaffId() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/classesByStaff/" + "U09")
                .contextPath("/lms")
                .header("Authorization", "Bearer " + token)
                .contentType("application/json")).andReturn();
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("classes with this staffId U09 not found", message);
    }
    ...
    public void testUpdateClassByInvalidStaffId() throws Exception {
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("Staff Id U10 not found", message);
    }
    ...
    public void testGetClassRecordingByBatchId() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/batchRecordings/" + 6)
                .contextPath("/lms")
                .header("Authorization", "Bearer " + token)
                .contentType("application/json")).andReturn();
