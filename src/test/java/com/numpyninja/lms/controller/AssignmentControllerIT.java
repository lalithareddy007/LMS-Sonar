...
public class AssignmentControllerIT {
    ...
    public void testCreateAssignment() throws Exception {
        ...
        assignmentDto.setCreatedBy("U06");
        assignmentDto.setBatchId(6);
        assignmentDto.setCsId(6L);
        assignmentDto.setGraderId("U06");
        ...
        assertEquals("U06", responseDto .getCreatedBy());
        assertEquals(6, responseDto.getBatchId());
        assertEquals(6, responseDto.getCsId());
        assertEquals("U06", responseDto .getGraderId());
    ...
    public void testCreatedByUser() throws Exception {
        ...
        assignmentDto.setPathAttachment4("FilePath4");
        assignmentDto.setPathAttachment5("FilePath5");
        assignmentDto.setCreatedBy("U09");
        assignmentDto.setBatchId(6);
        assignmentDto.setCsId(6L);
        assignmentDto.setGraderId("U06");
        Calendar calendar = (Calendar) Calendar.getInstance();
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("User not found with Role(Admin/Staff) : U09 ", message);
    }
    ...
    public void testValidRoleId() throws Exception {
        ...
        assignmentDto.setPathAttachment4("FilePath4");
        assignmentDto.setPathAttachment5("FilePath5");
        assignmentDto.setCreatedBy("U10");
        assignmentDto.setBatchId(6);
        assignmentDto.setCsId(6L);
        assignmentDto.setGraderId("U10");
        Calendar calendar = (Calendar) Calendar.getInstance();
        calendar.set(Calendar.MONTH, 10);
        calendar.set(Calendar.YEAR, 2023);
        calendar.set(Calendar.DAY_OF_WEEK, 14);
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("User not found with Role(Admin/Staff) : U10 ", message);
    }
    ...
    public void testAssignmentIdExist() throws Exception {
        ...
        String jsonRequest = obj.writeValueAsString(assignmentDto);
        MvcResult mvcResult = mockMvc.perform(put("/lms/assignments/" + 20)
                        .contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json")
                        .content(jsonRequest))
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("Assignment not found with Id : 20 ", message);
    }
    ...
    public void testGetAssignmentsForBatch() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/assignments/batch/" + 6).contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
        ...
        assertEquals("U06", assignmentDtoForAssignmentId.getCreatedBy());
        assertEquals(6, assignmentDtoForAssignmentId.getBatchId());
        assertEquals(6, assignmentDtoForAssignmentId.getCsId());
        assertEquals("U06", assignmentDtoForAssignmentId.getGraderId());
    }

    @Test
    @Order(12)
    public void testGetAssignmentByInvalidBatchId() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/assignments/batch/" + 9).contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
        ...
        assertEquals(false, apiResponse.isSuccess());
        assertEquals("Batch not found with Id : 9 ", message);
    }
