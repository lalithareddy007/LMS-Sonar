...
public class UserSkillControllerIntegrationTest {
    ...
    public void createUserSkillTest() throws Exception {
        ...
        userSkillDto.setUserId("U08");
        userSkillDto.setSkillId(10);
        ...
        assertEquals("U08", userskillDto.getUserId());
        assertEquals(10, userskillDto.getSkillId());
    ...
    public void testUpdateUserSkill() throws Exception {
        String userSkillId = userSkillRepository.findAll().get(0).getUserSkillId();
        final UserSkillDTO updateUserSkillDto = new UserSkillDTO();
        updateUserSkillDto.setUserSkillId(userSkillId);
        updateUserSkillDto.setUserId("U07");
        updateUserSkillDto.setSkillId(10);
