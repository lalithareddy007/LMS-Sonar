...
public class UserLoginControllerIT {
    ...
    public void testSignIn() throws Exception {
        ...
        loginDto.setUserLoginEmailId("Robert.Louis@gmail.com");
        loginDto.setPassword("Robert123");
        ...
        List<String> expectedRoles = Arrays.asList("ROLE_STUDENT");
    ...
    public void testForgotPasswordForEmailId() throws Exception {
        ...
        emailDto.setUserLoginEmailId("Robert.Louis@gmail.com");
