...
public class AttendanceControllerIT {
    ...
    public void testCreateAndSaveAttendance() throws Exception {
        ...
        attendanceDto.setAttId(1L);
        attendanceDto.setCsId((long) 6);
        attendanceDto.setStudentId("U08");
        ...
        assertEquals((long)6, responseDto.getCsId());
        assertEquals("U08", responseDto.getStudentId());
   ...
   //test update attendance by attendance Id
     ...
     public void testUpdateAttendance() throws Exception {
    	 ...
    	 long attendanceId=attRepository.findAll().get(0).getAttId();
    	 AttendanceDto attendanceDto = attService.getAttendanceById(attendanceId) ;
     ...
     public void testAttendanceAlreadyExist() throws Exception {
         ...
         assertEquals("Student U08's attendance is marked for Selenium, for "+ LocalDate.now(), message);
